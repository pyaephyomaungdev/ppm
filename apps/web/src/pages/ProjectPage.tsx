            ...
            <div className="mt-6 flex flex-wrap gap-3">
              {project.url ? (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center rounded-lg bg-[var(--ink)] px-4 py-2 text-sm font-medium text-[var(--paper)] transition hover:opacity-90"
                >
                  View live
                </a>
              ) : null}
              {project.repoUrl ? (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center rounded-lg border border-[var(--rule)] bg-white px-4 py-2 text-sm font-medium transition hover:border-[var(--ink)]"
                >
                  Source
                </a>
              ) : null}
